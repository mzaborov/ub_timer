...
function setReferee(ref)
{
    ...
    else
    {
        ...
        case  "deal":
                    ...
                    if (duelType === "express") {
                        document.getElementById("referee_hint").innerHTML = " <p>Критерии судейства экспресс-поединков в сообществе я-ИТ-ы:<ul class=\"font-size-sm line-height-sm\"><li>были ли навязаны определённые коммуникативные роли?</li><li>удалось ли поставить соперника в тупик (молчание) или вызвать у него растерянность и замешательство?</li><li>разрешился ли изначальный конфликт? Было ли предложено решение, которое способствовало повышению доверия и уважения к предложившему?</li><li>смог ли защищающийся изменить повестку, а агрессор сохранить её?</li><li>является ли решение ключом к более объёмной проблеме? Удалось ли попутно решить сопутствующие проблемы или, наоборот, они нарастают как снежный ком?</li><li>удалось ли защищающемуся скачкообразно изменить картину мира (просветление) агрессора, а агрессору сохранить свою изначальную позицию?</li><li>удалось ли агрессору остаться в глазах окружающих положительным героем?</li></ul></p>";
                    } else {
