...
Главная страница (выбор файла, поединка, настройка таймеров и ролей):

![Главная страница](docs/screenshot-main.png)

Десктоп — ход поединка (раунд, таймеры игроков, роли, интересы, текст ситуации):

![Ход поединка, десктоп](docs/screenshot-desktop-situation.png)

Десктоп — форма завершения поединка (судьи, выбор игрока, таймер рефери):

![Форма завершения поединка, десктоп](docs/screenshot-desktop-modal.png)
...
Форма завершения поединка на мобильном (модалка «Поединок завершен» — судьи, выбор игрока, таймер, кнопки):
