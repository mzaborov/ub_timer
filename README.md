...
| **Hidden** | *(необязательно)* Скрыть название ситуации в выпадашке «Выберите поединок» до клика по строке: `1`, `да`, `true` и т.п. Пустая ячейка или отсутствие колонки — название видно сразу (как в старых файлах без этой колонки). |
